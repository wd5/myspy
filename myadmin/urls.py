...
urlpatterns = patterns('',
                      ...
                      url(r'^sales/search/$', 'myadmin.views.search', name="search-page"),
                      ...
                      url(r'^client/(?P<id>[-\w]+)/get$', 'myadmin.views.get_client', name="get-client"),
                      ...
                      url(r'^charts/$', 'myadmin.views.charts', name="charts-page"),
