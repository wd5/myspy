...
def send_sms(cart_items, form):
    ...
    msg = "%s,%s,%s %s %s %s %s" % (form.cleaned_data['name'], form.cleaned_data['city'], form.cleaned_data['name'], form.cleaned_data['surname'], form.cleaned_data['address'], form.cleaned_data['postcode'] ,products)
